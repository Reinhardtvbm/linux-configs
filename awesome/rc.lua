...
beautiful.init("/home/reinhardt/.config/awesome/theme.lua")
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey }, "n", function() awful.spawn("foxitreader") end,
        { description = "pdfreader discord", group = "launcher" }),
    awful.key({ modkey }, "a", function() awful.spawn("arduino-ide") end,
        { description = "launch the Arduino IDE", group = "launcher" }),
...
-- commands that run when awesome starts

awful.spawn("picom")
awful.spawn("redshift -l -25.74486:28.18783")
